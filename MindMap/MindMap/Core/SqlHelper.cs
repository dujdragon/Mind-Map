...
namespace MindMap.Core
{
    ...
    {
        public string ConnectionString { get; set; } = "user id = sa; password = HA0djl0ha; initial catalog = MindMap   ; data source = 127.0.0.1; Connect Timeout = 30;TrustServerCertificate=True;";
